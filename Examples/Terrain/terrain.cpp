...
/*--------------------------------------------------------*/
/*  terrain.cpp : Fractal Terrain Generation              */
/*--------------------------------------------------------*/
...
#define INITIAL_X_ORIGIN -1.0
#define INITIAL_Y_ORIGIN -1.0
#define INITIAL_VERTICAL_SCALE 0.5
...
#define INITIAL_TEXTURE_GAIN 0.5
...
#define INITIAL_VALLEY_GREEN 0.25
...
void initializeCornerNormals()
{
  int w = resolution;
  int h = resolution;
  GLdouble xScale = 2.0/(GLdouble)(resolution-1);
  GLdouble yScale = 2.0/(GLdouble)(resolution-1);
...
void displayTerrain()
{
  ...
  for (int r=0; r< resolution-1; r++)
      ...
      for (int c=0; c< resolution; c++)
	{
	  ...
	  nx1 = terrainNormalX[r][c];
	  ny1 = terrainNormalY[r][c];
	  nz1 = terrainNormalZ[r][c];
	  ...
	  nx2 = terrainNormalX[r+1][c];
	  ny2 = terrainNormalY[r+1][c];
	  nz2 = terrainNormalZ[r+1][c];
...
int main(int argc, char** argv)
{
  ...
  glutCreateWindow ("Terrain Program");
